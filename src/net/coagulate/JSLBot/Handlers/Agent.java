...
public class Agent extends Handler {
    public Agent(@Nonnull final JSLBot bot, final Configuration c) {super(bot,c);}
    ...
    public String fovMaxCommand(final CommandEvent command) { bot.setMaxFOV(); return "Set"; }
    @Nonnull
    @CmdHelp(description="Sets the FOV (field of view) to Zero")
    public String fovMinCommand(final CommandEvent command) { bot.setMinFOV(); return "Set"; }
    @Nonnull
    @CmdHelp(description="Send agent update")
    public String updateCommand(final CommandEvent command) { bot.agentUpdate(); return "Sent"; }
    @Nonnull
    @CmdHelp(description = "Set agent's draw distance")
    public String drawdistanceCommand(final CommandEvent command,
                                      @Nullable @ParamHelp(description="Meters draw distance") final
                                      String set) {
