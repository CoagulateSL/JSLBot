...
public class Packet {
	 ...
	 */
	@Nullable
	public Message messageNullable() {
		return message;
	}
	...
	public Message message() {
		if (message==null) {
			throw new NullPointerException("Packet message is null");
		}
		return message;
	}
	...
	public int getFrequency() {
		return messageNullable().getFrequency();
	}
	
	public int getId() {
		return messageNullable().getId();
	}
	...
	public int size() {
		...
		if (getFrequency()==Frequency.HIGH) {
			total=total+1;
		}
		if (getFrequency()==Frequency.MEDIUM) {
			total=total+2;
		}
		if (getFrequency()==Frequency.LOW||getFrequency()==Frequency.FIXED) {
			total=total+4;
		}
	...
	public String getName() {
		return messageNullable().getName();
	}
